...
public class TitleSelectModePanel : TitlePanelBehaviour
{
    ...
    public void Update()
    {
        ...
        if (TitleUIManager.uiPlayer != null)
        {
            ...
            if (TitleUIManager.uiPlayer.GetButtonUp(CANCEL) && TitleSceneManager.CurrentPhase.GetType() == typeof(Title_SelectMode))
            {
                //タイトル初めから
            }
        }
