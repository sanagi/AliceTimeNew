...
public class GameMainPanel : GamePanelBehaviour
{
    ...
    [SerializeField]
    private GameButtonBehaviour menuButton = null;
    [SerializeField]
    private GameButtonBehaviour retryButton = null;
    ...
    protected override void Init()
    {
        ...
        menuButton = Instantiate(prefabMenuButton, transform).GetComponent<GameButtonBehaviour>();
        ...
        retryButton = Instantiate(prefabRetryButton, transform).GetComponent<GameButtonBehaviour>();
