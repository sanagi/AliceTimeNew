...
[System.Serializable]
public abstract class ExplorePanelBehaviour : UIMonobehaviour
{
    public abstract EXPLORESCENE TargetScene();

    public List<ExploreButtonBehaviour> activeButtonArray = new List<ExploreButtonBehaviour>();
    ...
    {
        ExploreUIManager.RegistedPanel(this);
    }
    ...
    {
        ExploreUIManager.UnregistedPanel(TargetScene(), this);
    }
