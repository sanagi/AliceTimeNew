    ...
    float4 screenPos)
{
    ...
    half radianceBase = _ReceiveShadows ? mainLight.shadowAttenuation * lightMapMask * NdotL : lightMapMask * NdotL;
    ...
    mainLightShadowArea = _ReceiveShadows ? mainLight.shadowAttenuation : 1;
