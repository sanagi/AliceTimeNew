Shader "Universal Render Pipeline/URPLLToonBGTransparentWave"
{
    Properties
    {
        [Header(MainTex)]
        ...
        */
        ...
        //_UVScaleFactor2 ("_UVScaleFactor2", float) = 120.0
    ...
    SubShader
    {
        ...
        */
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment ENABLE_WAVE
            #pragma multi_compile _ _MAIN_LIGHT_SHADOWS _MAIN_LIGHT_SHADOWS_CASCADE _MAIN_LIGHT_SHADOWS_SCREEN
            ...
            #pragma fragment LLFragmentBGWave
            // make fog work
            #pragma multi_compile_fog
            ENDHLSL
        }
