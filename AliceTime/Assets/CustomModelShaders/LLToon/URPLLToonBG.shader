Shader "Universal Render Pipeline/URPLLToonBG"
{
    Properties
    {
        [Header(MainTex)]
        ...
        [Toggle(ENABLE_EMISSION_ONLY)] _EnableEmissionOnly("Enable EmissionOnly", Float) = 0.0
        [Space(30)]
        ...
        [ToggleUI] _ReceiveShadows("Receive Shadow", int) = 1
        ...
        */
        ...
        [HideInInspector]_ReflectHeight("ReflectHeight", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile _ DYNAMICLIGHTMAP_ON
            #pragma multi_compile_fragment _ _GBUFFER_NORMALS_OCT
            #pragma multi_compile_fragment _ REFLECT
